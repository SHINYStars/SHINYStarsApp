...
class VolunteerEmail extends Component {
        ...
        return (
            <Row>
                <Col s={12} m={6} offset='m3'>
                    <Card
                        className="darken-1" textClassName="grey-text" title="Email Form">
                        <Row>
                            <Input
                                value={email}
                                name="email"
                                ...
                                className={(email.length && !emailValid) ? 'invalid' : ''}
                                autoComplete="off"
                            />
                        </Row>
                        <Row>
